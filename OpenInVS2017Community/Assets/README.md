[AppVeyorProjectUrl]: https://ci.appveyor.com/project/GregTrevellick/openinvs2017community
[AppVeyorProjectBuildStatusBadgeSvg]: https://ci.appveyor.com/api/projects/status/6ps18akav0f75gr1?svg=true
[GitHubPagesURL]: https://gregtrevellick.github.io/OpenInVS2017Community/
[GitHubRepoURL]: https://github.com/GregTrevellick/OpenInVS2017Community
[GitHubRepoIssuesURL]: https://github.com/GregTrevellick/OpenInVS2017Community/issues
[GitHubRepoPullRequestsURL]: https://github.com/GregTrevellick/OpenInVS2017Community/pulls
...
Open multiple files simultaneously in [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] directly from [Visual Studio's][VisualStudioURL] Solution Explorer.
...
The [owner](https://github.com/GregTrevellick) of this [GitHub repository / software][GitHubRepoURL] is not affiliated, associated, authorized, endorsed by, employed by, sponsored by, or in any way officially connected with [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] or any of its subsidiaries or its affiliates.

Nor has [this][GitHubRepoURL] software been authorised, approved, verified or in anyway assessed by [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage], or any of its subsidiaries or its affiliates, either as [raw source code][GitHubRepoURL] on [GitHub.com](https://github.com/) or as a [Visual Studio Extension][VSMarketplaceUrl] in the [Visual Studio Marketplace](https://marketplace.visualstudio.com/vs).

All Trademark, intellectual property rights, and other rights belonging to [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] as described in [here][ThirdPartyAppHomePage] apply.

All [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] logos and [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] links belong to [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] and their use here and any associated goodwill inures to [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage].

In no event shall [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] be liable for any claim, damages or other liability, whether in an action of contract, tort or otherwise, arising from, out of or in connection with the software or the use or dealings in the software.
...
Thanks also to [Visual Studio 2017 Community Edition][ThirdPartyAppHomePage] themselves.
