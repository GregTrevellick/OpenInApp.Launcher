[AppVeyorProjectUrl]: https://ci.appveyor.com/project/GregTrevellick/openinvs2013
[AppVeyorProjectBuildStatusBadgeSvg]: https://ci.appveyor.com/api/projects/status/m805v6aq2c1qurwh?svg=true
[GitHubPagesURL]: https://gregtrevellick.github.io/OpenInVS2013/
[GitHubRepoURL]: https://github.com/GregTrevellick/OpenInVS2013
[GitHubRepoIssuesURL]: https://github.com/GregTrevellick/OpenInVS2013/issues
[GitHubRepoPullRequestsURL]: https://github.com/GregTrevellick/OpenInVS2013/pulls
...
[VersionNumberBadgeURL]: https://vsmarketplacebadge.apphb.com/version/GregTrevellick.OpenInVisualStudio2013.svg
[VisualStudioURL]: https://www.visualstudio.com/
[VSMarketplaceUrl]: https://marketplace.visualstudio.com/items?itemName=GregTrevellick.OpeninVisualStudio2013
[VSMarketplaceReviewsUrl]: https://marketplace.visualstudio.com/items?itemName=GregTrevellick.OpeninVisualStudio2013#review-details
...
Open multiple files simultaneously in [Visual Studio 2013][ThirdPartyAppHomePage] directly from [Visual Studio's][VisualStudioURL] Solution Explorer.
...
The [owner](https://github.com/GregTrevellick) of this [GitHub repository / software][GitHubRepoURL] is not affiliated, associated, authorized, endorsed by, employed by, sponsored by, or in any way officially connected with [Visual Studio 2013][ThirdPartyAppHomePage] or any of its subsidiaries or its affiliates.

Nor has [this][GitHubRepoURL] software been authorised, approved, verified or in anyway assessed by [Visual Studio 2013][ThirdPartyAppHomePage], or any of its subsidiaries or its affiliates, either as [raw source code][GitHubRepoURL] on [GitHub.com](https://github.com/) or as a [Visual Studio Extension][VSMarketplaceUrl] in the [Visual Studio Marketplace](https://marketplace.visualstudio.com/vs).

All Trademark, intellectual property rights, and other rights belonging to [Visual Studio 2013][ThirdPartyAppHomePage] as described in [here][ThirdPartyAppHomePage] apply.

All [Visual Studio 2013][ThirdPartyAppHomePage] logos and [Visual Studio 2013][ThirdPartyAppHomePage] links belong to [Visual Studio 2013][ThirdPartyAppHomePage] and their use here and any associated goodwill inures to [Visual Studio 2013][ThirdPartyAppHomePage].

In no event shall [Visual Studio 2013][ThirdPartyAppHomePage] be liable for any claim, damages or other liability, whether in an action of contract, tort or otherwise, arising from, out of or in connection with the software or the use or dealings in the software.
...
Thanks also to [Visual Studio 2013][ThirdPartyAppHomePage] themselves.
