...
namespace OpenInFirefoxDeveloperEdition.Options.FirefoxDeveloperEdition
{
    public class GeneralOptions : DialogPage, IGeneralOptionsFile
    {
        ...
        private const string CommonActualPathToExeOptionLabel = CommonConstants.ActualPathToExeOptionLabelPrefix + KeyToExecutableString.FirefoxDeveloperEdition;
