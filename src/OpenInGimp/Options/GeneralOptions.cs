...
namespace OpenInAppGimp.Options.Gimp
{
    public class GeneralOptions : DialogPage, IGeneralOptionsFile
    {
        ...
        private const string CommonActualPathToExeOptionLabel = CommonConstants.ActualPathToExeOptionLabelPrefix + KeyToExecutableString.Gimp;
