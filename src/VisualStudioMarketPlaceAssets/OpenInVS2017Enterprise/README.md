...
Open multiple files and/or folders simultaneously in [Visual Studio 2017 Enterprise Edition][ThirdPartyAppHomePage] directly from [Visual Studio's][VisualStudioURL] Code Editor window and / or Solution Explorer.
...
- Open multiple files and/or folders simultaneously in [Visual Studio 2017 Enterprise Edition][ThirdPartyAppHomePage].
