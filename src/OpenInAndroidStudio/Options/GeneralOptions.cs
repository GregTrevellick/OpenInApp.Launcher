...
namespace OpenInAndroidStudio.Options.AndroidStudio
{
    ...
    {
        internal static KeyToExecutableEnum keyToExecutableEnum = KeyToExecutableEnum.AndroidStudio;
        ...
        private const string CommonActualPathToExeOptionLabel = CommonConstants.ActualPathToExeOptionLabelPrefix + KeyToExecutableString.AndroidStudio;
