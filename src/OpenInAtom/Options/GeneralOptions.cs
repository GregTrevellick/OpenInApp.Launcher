...
namespace OpenInAtom.Options.Atom
{
    ...
    {
        internal static KeyToExecutableEnum keyToExecutableEnum = KeyToExecutableEnum.Atom;
        ...
        private const string CommonActualPathToExeOptionLabel = CommonConstants.ActualPathToExeOptionLabelPrefix + KeyToExecutableString.Atom;
