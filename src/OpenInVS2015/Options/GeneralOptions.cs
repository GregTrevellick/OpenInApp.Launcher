...
namespace OpenInVS2015.Options.VS2015
{
    public class GeneralOptions : DialogPage, IGeneralOptionsFile
    {
        ...
        private const string CommonActualPathToExeOptionLabel = CommonConstants.ActualPathToExeOptionLabelPrefix + KeyToExecutableString.VS2015;
