...
- Open multiple files simultaneously in [Firefox Developer Edition][ThirdPartyAppHomePage] with VS2012, VS2013 and VS2015.
...
The [owner](https://github.com/GregTrevellick) of this [GitHub repository / software][GitHubRepoURL] is not affiliated, associated, authorized, endorsed by, employed by, sponsored by, or in any way officially connected with [Firefox Developer Edition][ThirdPartyAppHomePage] or any of its subsidiaries or its affiliates.

Nor has [this][GitHubRepoURL] software been authorised, approved, verified or in anyway assessed by [Firefox Developer Edition][ThirdPartyAppHomePage], or any of its subsidiaries or its affiliates, either as [raw source code][GitHubRepoURL] on [GitHub.com](https://github.com/) or as a [Visual Studio Extension][VSMarketplaceUrl] in the [Visual Studio Marketplace](https://marketplace.visualstudio.com/vs).

All Trademark, intellectual property rights, and other rights belonging to [Firefox Developer Edition][ThirdPartyAppHomePage] as described in [here][ThirdPartyAppHomePage] apply.

All [Firefox Developer Edition][ThirdPartyAppHomePage] logos and [Firefox Developer Edition][ThirdPartyAppHomePage] links belong to [Firefox Developer Edition][ThirdPartyAppHomePage] and their use here and any associated goodwill inures to [Firefox Developer Edition][ThirdPartyAppHomePage].

In no event shall [Firefox Developer Edition][ThirdPartyAppHomePage] be liable for any claim, damages or other liability, whether in an action of contract, tort or otherwise, arising from, out of or in connection with the software or the use or dealings in the software.
...
- [Firefox Developer Edition][ThirdPartyAppHomePage] 
